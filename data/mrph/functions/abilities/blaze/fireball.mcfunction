...
execute anchored eyes positioned ^ ^ ^ run summon minecraft:small_fireball ^ ^ ^1 {Tags:["mrph_blaze_fireball","mrph_new_fireball"]}
#give motion values to fireball

    execute store result score @e[type=minecraft:small_fireball,tag=mrph_new_fireball,limit=1] mrph_fb_d1 run scoreboard players get x2 mrph_global

    execute store result score @e[type=minecraft:small_fireball,tag=mrph_new_fireball,limit=1] mrph_fb_d2 run scoreboard players get y2 mrph_global

    execute store result score @e[type=minecraft:small_fireball,tag=mrph_new_fireball,limit=1] mrph_fb_d3 run scoreboard players get z2 mrph_global

#untag
tag @e[type=minecraft:small_fireball,tag=mrph_new_fireball,limit=1] remove mrph_new_fireball
