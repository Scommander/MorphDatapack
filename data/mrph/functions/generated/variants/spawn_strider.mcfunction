...
summon minecraft:strider ~ ~ ~ {DeathLootTable:"yhgdsffgfhvbfyutgsyugf",DeathTime:19s,Invulnerable:1b,NoGravity:1b,Tags:["mrph_mob","mrph_new"],ActiveEffects:[{Id:11b,Amplifier:100b,Duration:1000000,ShowParticles:0b}]}
function mrph:generated/variants/edit_strider
