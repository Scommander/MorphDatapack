#./data/mrph/functions/generated/advancements/axolotlvariant0.mcfunction axolotl
...
execute unless score @s mrph_axllt1 matches 1.. run scoreboard players set @s mrph_axllt1 1