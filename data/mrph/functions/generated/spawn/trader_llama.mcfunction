...
execute if score @s mrph_tradm1 matches 0 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_trader_llamaage1", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 57921182"}},{"color":"gray","nbt": "mrph_trader_llamaage-2147483648", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 189679591"}}]

execute if score @s mrph_tradm1 matches 1 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"yellow","nbt": "mrph_trader_llamaage1", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 57921182"}},{"color":"gray","nbt": "mrph_trader_llamaage-2147483648", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 189679591"}}]

execute if score @s mrph_tradm1 matches 2 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_trader_llamaage1", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 57921182"}},{"color":"yellow","nbt": "mrph_trader_llamaage-2147483648", "storage": "mrph_trader_llama","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 189679591"}}]
