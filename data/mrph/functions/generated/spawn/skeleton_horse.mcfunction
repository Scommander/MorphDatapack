...
summon minecraft:skeleton_horse ~ ~ ~ {DeathLootTable:"yhgdsffgfhvbfyutgsyugf",Invulnerable:1b,DeathTime:19s,NoGravity:1b,Tags:["mrph_mob","mrph_new"],ActiveEffects:[{Id:11b,Amplifier:100b,Duration:1000000,ShowParticles:0b}]}
