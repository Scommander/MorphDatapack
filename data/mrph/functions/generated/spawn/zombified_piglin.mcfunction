...
execute if score @s mrph_zonbi1 matches 0 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_zombified_piglinisbaby0", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 462995967"}},{"color":"gray","nbt": "mrph_zombified_piglinisbaby1", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1633728523"}}]

execute if score @s mrph_zonbi1 matches 1 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"yellow","nbt": "mrph_zombified_piglinisbaby0", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 462995967"}},{"color":"gray","nbt": "mrph_zombified_piglinisbaby1", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1633728523"}}]

execute if score @s mrph_zonbi1 matches 2 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_zombified_piglinisbaby0", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 462995967"}},{"color":"yellow","nbt": "mrph_zombified_piglinisbaby1", "storage": "mrph_zombified_piglin","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1633728523"}}]
