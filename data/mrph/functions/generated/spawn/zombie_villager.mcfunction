...
execute if score @s mrph_zorbe1 matches 0 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_zombie_villagerisbaby0", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 785734130"}},{"color":"gray","nbt": "mrph_zombie_villagerisbaby1", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 898702814"}}]

execute if score @s mrph_zorbe1 matches 1 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"yellow","nbt": "mrph_zombie_villagerisbaby0", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 785734130"}},{"color":"gray","nbt": "mrph_zombie_villagerisbaby1", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 898702814"}}]

execute if score @s mrph_zorbe1 matches 2 run tellraw @s ["",{"color":"white","bold":false,"text":"Baby?: "},{"color":"gray","nbt": "mrph_zombie_villagerisbaby0", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 785734130"}},{"color":"yellow","nbt": "mrph_zombie_villagerisbaby1", "storage": "mrph_zombie_villager","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 898702814"}}]
