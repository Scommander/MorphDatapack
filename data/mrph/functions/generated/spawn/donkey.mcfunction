tellraw @s ["",{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n>>>------>>> ","color":"light_purple"},{"text":"Donkey Options","color":"white","bold":true},{"text":" <<<------<<<","color":"light_purple"}]
#sets storage to mob variants
data modify storage mrph_donkey mrph_donkeyage1 set value ""
execute if entity @s[tag=mrph_donkeyage1] run data modify storage mrph_donkey mrph_donkeyage1 set value "[No] "


#sets storage to mob variants
data modify storage mrph_donkey mrph_donkeyage-2147483648 set value ""
