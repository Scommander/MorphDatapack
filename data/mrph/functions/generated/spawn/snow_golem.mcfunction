...
execute if score @s mrph_snmwe1 matches 0 run tellraw @s ["",{"color":"white","bold":false,"text":"Has Pumpkin?: "},{"color":"gray","nbt": "mrph_snow_golempumpkin0", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1233604896"}},{"color":"gray","nbt": "mrph_snow_golempumpkin1", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1211297688"}}]

execute if score @s mrph_snmwe1 matches 1 run tellraw @s ["",{"color":"white","bold":false,"text":"Has Pumpkin?: "},{"color":"yellow","nbt": "mrph_snow_golempumpkin0", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1233604896"}},{"color":"gray","nbt": "mrph_snow_golempumpkin1", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1211297688"}}]

execute if score @s mrph_snmwe1 matches 2 run tellraw @s ["",{"color":"white","bold":false,"text":"Has Pumpkin?: "},{"color":"gray","nbt": "mrph_snow_golempumpkin0", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1233604896"}},{"color":"yellow","nbt": "mrph_snow_golempumpkin1", "storage": "mrph_snow_golem","clickEvent":{"action":"run_command","value":"/trigger mrph_subtrigger set 1211297688"}}]
